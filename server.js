...
app.use(express.static('public')) // tell express to try and match requests with 'public' directory files
...
// DELETE
// backend only functionality used to delete a fruit
...
// UPDATE
// backend only functionality used to update a fruit
...
// CREATE
// backend onl functionality that is used to create a fruit
